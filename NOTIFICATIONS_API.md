...
## Настройки пятничного напоминания

Напоминание по умолчанию включено и запланировано на `18:00` в timezone активного
устройства пользователя. Backend проверяет расписание каждые 15 минут. Одному
пользователю оно не отправляется дважды в одну локальную пятницу.
